...
MPU9250 IMU(Wire,MPU_I2C);                              //An IMU object is defined in order to read MPU9250
Adafruit_BME680 bme;                                    //An bme object is defined in order to read BME680
INA226 ina;                                             //An ina object is defined in order to read INA226
